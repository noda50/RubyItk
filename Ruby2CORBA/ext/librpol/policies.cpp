...
#endif
{
  ...
  // POA Policy support
  r2tao_nsPOA = k = rb_eval_string("::R2CORBA::PortableServer::POA");
  ...
  rb_define_method(k, "servant_retention_policy", RUBY_METHOD_FUNC(r2tao_POA_create_servant_retention_policy), 1);
...
static VALUE rCORBA_ORB_create_policy(VALUE self, VALUE identifier, VALUE any)
{
  ...
  {
    CORBA::Any _xval;
    r2tao_Ruby_to_Any(_xval, any, orb);
    ...
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_Policy_copy(VALUE self)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (_pol.in ());
    ret = r2tao_Object_t2r (polobj);
    ret = rb_funcall (r2tao_nsPolicy, rb_intern ("_narrow"), 1, ret);
  }
  R2TAO_CATCH;
...
VALUE r2tao_Object_get_policy(VALUE self, VALUE ptype)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy. in());
    VALUE rpol = r2tao_Object_t2r (polobj);
    rpol = rb_funcall (r2tao_nsPolicy, rb_intern ("_narrow"), 1, rpol);
    return rpol;
  }
  R2TAO_CATCH;
...
VALUE r2tao_Object_get_policy_overrides(VALUE self, VALUE ptseq)
{
  ...
  R2TAO_TRY
  {
    CORBA::ULong alen = static_cast<unsigned long> (RARRAY (ptseq)->len);
    ...
    for (CORBA::ULong l=0; l<policies->length () ;++l)
    {
      ...
      CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (_policy);
      VALUE rpol = r2tao_Object_t2r (polobj);
      rpol = rb_funcall (r2tao_nsPolicy, rb_intern ("_narrow"), 1, rpol);
...
VALUE r2tao_Object_set_policy_overrides(VALUE self, VALUE policies, VALUE set_or_add)
{
  ...
  R2TAO_TRY
  {
    CORBA::ULong alen = static_cast<unsigned long> (RARRAY (policies)->len);
...
static VALUE r2tao_PolicyManager_set_policy_overrides(VALUE self, VALUE policies, VALUE set_or_add)
{
  ...
  R2TAO_TRY
  {
    ...
    _polman->set_policy_overrides (pollist, static_cast<CORBA::SetOverrideType> (NUM2LONG (set_or_add)));
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_lifespan_policy(VALUE self, VALUE value)
{
  ...
  rb_funcall (rpoltc, rb_intern ("validate"), 1, value);
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsLifespanPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_id_uniqueness_policy(VALUE self, VALUE value)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsIdUniquenessPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_id_assignment_policy(VALUE self, VALUE value)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsIdAssignmentPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_implicit_activation_policy(VALUE self, VALUE value)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsImplicitActivationPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_servant_retention_policy(VALUE self, VALUE value)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsServantRetentionPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
...
VALUE r2tao_POA_create_request_processing_policy(VALUE self, VALUE value)
{
  ...
  R2TAO_TRY
  {
    ...
    CORBA::Object_ptr polobj = dynamic_cast<CORBA::Object_ptr> (policy.in ());
    rpolicy = r2tao_Object_t2r (polobj);
    rpolicy = rb_funcall (r2tao_nsRequestProcessingPolicy, rb_intern ("_narrow"), 1, rpolicy);
  }
  R2TAO_CATCH;
